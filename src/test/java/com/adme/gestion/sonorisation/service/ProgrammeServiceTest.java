...
//
//  @InjectMocks
//  GenererProgrammeService genererProgrammeService;
//
//  @Captor
...
//        programme);
//
//    genererProgrammeService.save(programme);
//
...
//        .build();
//    toUpdate.setAssignations(buildAssignationConsole(toUpdate));
//    toUpdate.setAssignations(buildAssignationConsole(toUpdate));
...
//
//    genererProgrammeService.save(toUpdate);
//
//    verify(programmeRepository).save(programmeSonorisationArgumentCaptor.capture());
//
...
//  }
//
//  private Set<Assignation> buildAssignationConsole(Programme programme) {
//    Set<Assignation> assignations = new HashSet<>();
//    assignations.add(Assignation.builder()
//        .programme(programme)
//        .dateAssignation(LocalDateTime.now())
//        .proclamateur(buildProclamateur())
//        .build());
